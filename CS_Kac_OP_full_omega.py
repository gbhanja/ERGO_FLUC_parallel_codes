...
# Full path
filename = os.path.join(data_folder, "CS_Kac_OP_full_omega.npz")
...
τ_results = Parallel(n_jobs=64)(delayed(compute_tau)(ω0) for ω0 in tqdm(ω0_arr, desc="Running simulation 1"))
