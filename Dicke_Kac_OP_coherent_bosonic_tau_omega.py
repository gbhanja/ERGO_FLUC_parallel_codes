...
# Full path
filename = os.path.join(data_folder, "Dicke_Kac_OP_coherent_bosonic_tau_omega.npz")
...
results = Parallel(n_jobs=-1)(delayed(compute_ergotropy)(ω0) for ω0 in tqdm(ω0_arr, desc="Running simulation 1"))
...
if os.path.exists(filename):
    ...
    results = Parallel(n_jobs=-1)(
        delayed(compute_ergotropy)(ω0)
        for ω0 in tqdm(ω0_arr, desc="Ergotropy")
    )
