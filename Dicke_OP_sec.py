...
# Full path
filename = os.path.join(data_folder, "Dicke_OP_sec.npz")
...
def compute_ergotropy(i, N):
    ...
    return N, τ, E_B, E_erg, Ratio, ΔE2, W_2
...
if os.path.exists(filename):
    ...
    N_out, tau_out, Eb_out, Eerg_out, ratio_out, var_out, W2_out = zip(*results)
