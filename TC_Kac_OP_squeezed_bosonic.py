...
N_arr = np.arange(2, 202, 2)   
nmax = 3*N_arr[-1] + 1           # maximum photon number in the cavity
ω = 1.0
ω0 = 1.0
g = 1.0
...
# Full path
filename = os.path.join(data_folder, "TC_Kac_OP_squeezed_bosonic.npz")
...
def compute_tau(N):
    ...
    psi0 = initial_state(N, nmax, "squeezed")
